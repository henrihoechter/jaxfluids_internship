...
def compute_source_terms(
    ...
    equation_manager: equation_manager_types.EquationManager2D,
    primitives: equation_manager_utils.Primitives2D | None = None,
...
def compute_eT_relaxation(
    ...
    # Extract primitives
    Y_s, rho, _, _, T, T_v, p = equation_manager_utils.extract_primitives_from_U(
        U, equation_manager
    )
